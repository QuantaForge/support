 ...
 * @method static \QuantaForge\Foundation\Application setBasePath(string $basePath)
 * @method static string path(string $path = '')
 * @method static \QuantaForge\Foundation\Application useAppPath(string $path)
 * @method static string basePath(string $path = '')
 * @method static string bootstrapPath(string $path = '')
 * @method static \QuantaForge\Foundation\Application useBootstrapPath(string $path)
 * @method static string configPath(string $path = '')
 * @method static \QuantaForge\Foundation\Application useConfigPath(string $path)
 * @method static string databasePath(string $path = '')
 * @method static \QuantaForge\Foundation\Application useDatabasePath(string $path)
 * @method static string langPath(string $path = '')
 * @method static \QuantaForge\Foundation\Application useLangPath(string $path)
 * @method static string publicPath(string $path = '')
 * @method static \QuantaForge\Foundation\Application usePublicPath(string $path)
 * @method static string storagePath(string $path = '')
 * @method static \QuantaForge\Foundation\Application useStoragePath(string $path)
 * @method static string resourcePath(string $path = '')
 * @method static string viewPath(string $path = '')
 * @method static string joinPaths(string $basePath, string $path = '')
 * @method static string environmentPath()
 * @method static \QuantaForge\Foundation\Application useEnvironmentPath(string $path)
 * @method static \QuantaForge\Foundation\Application loadEnvironmentFrom(string $file)
 ...
 * @method static \QuantaForge\Support\ServiceProvider register(\QuantaForge\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \QuantaForge\Support\ServiceProvider|null getProvider(\QuantaForge\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\QuantaForge\Support\ServiceProvider|string $provider)
 * @method static \QuantaForge\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \QuantaForge\Foundation\Application addAbsoluteCachePathPrefix(string $prefix)
 * @method static \QuantaForge\Contracts\Foundation\MaintenanceMode maintenanceMode()
 * @method static bool isDownForMaintenance()
 * @method static never abort(int $code, string $message = '', array $headers = [])
 * @method static \QuantaForge\Foundation\Application terminating(callable|string $callback)
 ...
 * @method static \QuantaForge\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \QuantaForge\Foundation\Application getInstance()
 * @method static \QuantaForge\Contracts\Container\Container|\QuantaForge\Foundation\Application setInstance(\QuantaForge\Contracts\Container\Container|null $container = null)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \QuantaForge\Foundation\Application
 */

 ...
 * @method static \QuantaForge\Session\SessionManager extend(string $driver, \Closure $callback)
 * @method static array getDrivers()
 * @method static \QuantaForge\Contracts\Container\Container getContainer()
 * @method static \QuantaForge\Session\SessionManager setContainer(\QuantaForge\Contracts\Container\Container $container)
 * @method static \QuantaForge\Session\SessionManager forgetDrivers()
 ...
 * @method static void setRequestOnHandler(\QuantaForge\Http\Request $request)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 *
 * @see \QuantaForge\Session\SessionManager
 */

 ...
 * @method static \QuantaForge\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \QuantaForge\Queue\QueueManager setApplication(\QuantaForge\Contracts\Foundation\Application $app)
 ...
 * @method static \QuantaForge\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \QuantaForge\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \QuantaForge\Container\Container getContainer()
 * @method static void setContainer(\QuantaForge\Container\Container $container)
 * @method static \QuantaForge\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \QuantaForge\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static bool hasPushed(string $job)
 * @method static bool shouldFakeJob(object $job)
 * @method static array pushedJobs()
 * @method static \QuantaForge\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \QuantaForge\Queue\QueueManager
 * @see \QuantaForge\Queue\Queue
 * @see \QuantaForge\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \QuantaForge\Support\Testing\Fakes\QueueFake
     */

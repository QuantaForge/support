...
/**
 * @method static \QuantaForge\Http\Request capture()
 * @method static \QuantaForge\Http\Request instance()
 ...
 * @method static \QuantaForge\Http\Request merge(array $input)
 * @method static \QuantaForge\Http\Request mergeIfMissing(array $input)
 * @method static \QuantaForge\Http\Request replace(array $input)
 * @method static mixed get(string $key, mixed $default = null)
 * @method static \Symfony\Component\HttpFoundation\InputBag|mixed json(string|null $key = null, mixed $default = null)
 * @method static \QuantaForge\Http\Request createFrom(\QuantaForge\Http\Request $from, \QuantaForge\Http\Request|null $to = null)
 * @method static \QuantaForge\Http\Request createFromBase(\Symfony\Component\HttpFoundation\Request $request)
 * @method static \QuantaForge\Http\Request duplicate(array|null $query = null, array|null $request = null, array|null $attributes = null, array|null $cookies = null, array|null $files = null, array|null $server = null)
 ...
 * @method static \QuantaForge\Contracts\Session\Session session()
 * @method static void setQuantaForgeSession(\QuantaForge\Contracts\Session\Session $session)
 * @method static void setRequestLocale(string $locale)
 * @method static void setDefaultRequestLocale(string $locale)
 * @method static mixed user(string|null $guard = null)
 * @method static \QuantaForge\Routing\Route|object|string|null route(string|null $param = null, mixed $default = null)
 * @method static string fingerprint()
 * @method static \QuantaForge\Http\Request setJson(\Symfony\Component\HttpFoundation\InputBag $json)
 * @method static \Closure getUserResolver()
 * @method static \QuantaForge\Http\Request setUserResolver(\Closure $callback)
 * @method static \Closure getRouteResolver()
 * @method static \QuantaForge\Http\Request setRouteResolver(\Closure $callback)
 ...
 * @method static \QuantaForge\Http\Request createFromGlobals()
 * @method static \QuantaForge\Http\Request create(string $uri, string $method = 'GET', array $parameters = [], array $cookies = [], array $files = [], array $server = [], string|resource|null $content = null)
 ...
 * @method static string|array|null old(string|null $key = null, \QuantaForge\Database\Eloquent\Model|string|array|null $default = null)
 ...
 * @method static \QuantaForge\Http\Request|mixed whenHas(string $key, callable $callback, callable|null $default = null)
 ...
 * @method static \QuantaForge\Http\Request|mixed whenFilled(string $key, callable $callback, callable|null $default = null)
 * @method static bool missing(string|array $key)
 * @method static \QuantaForge\Http\Request|mixed whenMissing(string $key, callable $callback, callable|null $default = null)
 * @method static array keys()
 * @method static array all(array|mixed|null $keys = null)
 * @method static mixed input(string|null $key = null, mixed $default = null)
 * @method static \QuantaForge\Support\Stringable str(string $key, mixed $default = null)
 * @method static \QuantaForge\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \QuantaForge\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \QuantaForge\Support\Collection collect(array|string|null $key = null)
 ...
 * @method static \QuantaForge\Http\UploadedFile|\QuantaForge\Http\UploadedFile[]|array|null file(string|null $key = null, mixed $default = null)
 * @method static never dd(mixed ...$keys)
 * @method static \QuantaForge\Http\Request dump(mixed $keys = [])

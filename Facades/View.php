...
/**
 * @method static \QuantaForge\Contracts\View\View file(string $path, \QuantaForge\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \QuantaForge\Contracts\View\View make(string $view, \QuantaForge\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \QuantaForge\Contracts\View\View first(array $views, \QuantaForge\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \QuantaForge\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \QuantaForge\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \QuantaForge\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static \QuantaForge\View\Factory addNamespace(string $namespace, string|array $hints)
 * @method static \QuantaForge\View\Factory prependNamespace(string $namespace, string|array $hints)
 * @method static \QuantaForge\View\Factory replaceNamespace(string $namespace, string|array $hints)
 ...
 * @method static \QuantaForge\View\Engines\EngineResolver getEngineResolver()
 * @method static \QuantaForge\View\ViewFinderInterface getFinder()
 * @method static void setFinder(\QuantaForge\View\ViewFinderInterface $finder)
 ...
 * @method static void setContainer(\QuantaForge\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\QuantaForge\Contracts\View\View|\QuantaForge\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\QuantaForge\Contracts\View\View $view)
 * @method static void callCreator(\QuantaForge\Contracts\View\View $view)

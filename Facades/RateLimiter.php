...
/**
 * @method static \QuantaForge\Cache\RateLimiter for(string $name, \Closure $callback)
 ...
 *
 * @see \QuantaForge\Cache\RateLimiter
 */
class RateLimiter extends Facade
{
    ...
    {
        return \QuantaForge\Cache\RateLimiter::class;
    }
}

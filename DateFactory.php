 ...
 *
 * @method \QuantaForge\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \QuantaForge\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \QuantaForge\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \QuantaForge\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \QuantaForge\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \QuantaForge\Support\Carbon fromSerialized($value)
 ...
 * @method \QuantaForge\Support\Carbon|null getTestNow()
 ...
 * @method \QuantaForge\Support\Carbon instance($date)
 ...
 * @method \QuantaForge\Support\Carbon|null make($var)
 * @method \QuantaForge\Support\Carbon maxValue()
 * @method \QuantaForge\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \QuantaForge\Support\Carbon now($tz = null)
 * @method \QuantaForge\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \QuantaForge\Support\Carbon today($tz = null)
 * @method \QuantaForge\Support\Carbon tomorrow($tz = null)
 ...
 * @method \QuantaForge\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**

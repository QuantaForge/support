...
use QuantaForge\Contracts\Support\DeferringDisplayableValue;
use QuantaForge\Contracts\Support\Htmlable;
use QuantaForge\Support\Arr;
use QuantaForge\Support\Env;
use QuantaForge\Support\HigherOrderTapProxy;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \QuantaForge\Contracts\Support\DeferringDisplayableValue|\QuantaForge\Contracts\Support\Htmlable|\BackedEnum|string|null  $value
...
if (! function_exists('str')) {
     ...
     * @return \QuantaForge\Support\Stringable|mixed
     */
